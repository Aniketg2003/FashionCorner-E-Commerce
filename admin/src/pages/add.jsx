  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)} value={desciption} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Write content here' required />
      </div>

      <div className='w-full'>
        <p className='mb-2'>Full Product Description (Detailed)</p>
        <textarea 
          onChange={(e)=>setFullDescription(e.target.value)} 
          value={fullDescription} 
          className='w-full max-w-[500px] px-3 py-2 h-32' 
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <select onChange={(e)=>setSubcategory(e.target.value)} className='w-full px-2 py-2'>
            ...
            <option value="Winterwear">Winter</option>
          </select>
        </div>

        <div>
          <p className='mb-2'>Product Price</p>
          <input onChange={(e)=>setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='300' />
        </div>
